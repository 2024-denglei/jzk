...
from jzk.domain.preference.schema import EXTENDED_FIELDS
...
from jzk.advisor.generation_worker import GenerationCancelled, GenerationControl, GenerationOutput
