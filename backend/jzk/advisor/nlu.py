...
from jzk.config import LLM_API_KEY, LLM_BASE_URL, LLM_MODEL
...
- 脸型(face_shape)：长方、长、椭圆、瓜子；"圆脸"→椭圆，"方脸"→长方。禁止写圆/方/菱形
- 眼皮(eyelid)：单、双；"双眼皮"→双。禁止写内双
- 唇型(lip_shape)：一般、厚、薄；"厚唇"→厚，"薄唇/适中"→薄/一般。禁止写厚唇/薄唇/适中字面值
