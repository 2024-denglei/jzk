  ...
  return (
    <div className={adminPageShellClass('gap-0')}>
      ...
      <section className="mt-4 flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-[#dce4ee] bg-white">
        ...
        <div className={`min-h-0 flex-1 ${tab === 'chats' ? 'overflow-hidden' : 'overflow-auto'}`}>
